...
function loadQuestion() {
    return `<div> <fieldset>
        ...
        <legend class="question">${myQuestions[currentQuestion].question}</legend> <br>
        <input type="radio" name="exercise-question" class="exercise-question" id="answer1-1" tabindex="0" value="a"> <label for="answer1-1">${myQuestions[currentQuestion].answers.a}</label>
        ...
        <label for="answer1-4">${myQuestions[currentQuestion].answers.d}</label> <br>
...
function loadCorrectFeedback() {
    return `<p><br>That is correct! Way to go!</p>
  <button class = "submitNext" type="submit"> Next </button>
    
  <p>Question ${currentQuestion + 1} of ${myQuestions.length}</p>
        <p>${answeredCorrect} of ${myQuestions.length} correct</p>
        
        <img src="images/happy_heart.png" class="happyhrt" alt="correct answer" >
`;
...
function loadIncorrectFeedback() {
    return `<p><br>I'm sorry that is incorrect. But keep trying!</p>
   ...
   <p>Question ${currentQuestion + 1} of ${myQuestions.length}</p>
        ...
        <img src="images/sad_face.png" class="sadface" alt="correct answer" >
        `;
};
function loadInput() {
    return `<p><br>Please select an option. You can't escape a question. </p>
   <button class = "submitNext" type="submit"> Next </button>
...
function loadExitPage() {
    return `<p><br>You scored ${answeredCorrect} out of ${myQuestions.length}.</p><br><p>You can use your answers to create a study guide or click the Restart button below</p> <p>if you'd like to try again. Best of luck and remember you are a Rock Star!</p><br>
